...
const copiedNames = ['Adam', 'Jane', ...nameOne,...nameTwo];
...
/*
    ...
    This is so the values that were pulled out gets placed into our new
...
console.log(Math.min(...prices)); //...pulls values from the array. Spread op pulls elements out of the prices array to allow the min method to work
...
3 Data Types that are passed by reference: Array, Functions, and Objects
    ...
    * pretend datatype: address - denoted by < >
    ...
    pass by value: strings, number, Booleans, null and undefined
*/
